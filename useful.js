function getImageUrl(klass) {
    var urls = {
        ...
        'tremor':'https://api.cosm.com/v2/feeds/89487/datastreams/bed-tremor.png?width=1000&height=180&colour=%23f15a24&duration=9hours&title=Tremor&stroke_size=1&show_axis_labels=true&detailed_grid=true&scale=manual&min=0.2&max=0.50&timezone=Tokyo',
